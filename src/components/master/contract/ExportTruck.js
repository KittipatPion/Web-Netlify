...
const ExportTruck = () => {
  ...
  const handleChangSearch = (type) => (e, value) => {
    ...
    obj.RateType = document.getElementById("in-search-RateType").value;
  ...
  const clickSearch = (arr) => {
    console.log(arr);
    fnGetExportTruckListBySearch(arr);
  };
  ...
  const onClickAddData = () => {
    ...
    console.log("add header", newArrHeader);
    console.log("add shipto", newArrShipTo);
    console.log("add fuelRate", newArrCalFuelRateList);
  ...
  const onClickCloneData = () => {
    ...
    console.log("clone header", newArrHeader);
    console.log("clone shipto", newArrShipTo);
    console.log("clone fuelRate", newArrCalFuelRateList);
                    ...
                    >
                      <CInputGroup className="input-prepend">
                        ...
                        <CInput
                          ...
                          step="0.001"
                          min="0"
                          max={_headerMaxValueForMin}
                          onWheel={(e) => e.target.blur()}
                          // value={isClone ? minQtyValue : null}
                          onChange={_setMinValueInMaxHearder}
                          required
                        />
                        <CInvalidFeedback>
                          {Constant.inValidNullMessage}
                    ...
                    >
                      <CInputGroup className="input-prepend">
                        ...
                        <CInput
                          ...
                          step="0.001"
                          onWheel={(e) => e.target.blur()}
                          min={_headerMinValueForMax}
                          // value={isClone ? maxQtyValue : null}
                          onChange={_setMaxValueInMinHearder}
                          required
                        />
  ...
  const fnGetExportTruckListBySearch = (arr) => {
    setIsPostingData(true);
    Repository.fetchExportTruckListBySearch(arr).then(
      (result) => {
        setIsPostingData(false);
        setIsLoaded(true);
        if (result.httpCode === "200") {
    ...
    Repository.fetchExportVesselTruckBySearchById(index).then(
      (result) => {
        ...
        if (result.httpCode === "200") {
          ...
          console.log("Export Truck", result.data);
        } else {
          setErrorAPI(result);
        }
      },
