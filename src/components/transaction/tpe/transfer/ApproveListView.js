...
const ApproveCreditDebitView = () => {
  ...
  const empCode = "/tnsctpecdcdv";
  const trstCode = "/tnsctrstcdcdv";
  ...
  const onClickSearchData = () => {
    ...
    var transporterTypeId = null;
    //  parseInt(document.getElementById("transporter-type").value);
    var trucktypeId = null;
    var extraChargeGroupId = null;
    // parseInt(document.getElementById("extracharge-group").value);
  ...
  const fnGetExtraChargeNameOnlyList = () => {
    if (!extraChargeNameList.length) {
      Repository.fetchGetExtraChargeNameOnlyList().then(
        (result) => {
          if (result.httpCode === "200") {
            var filterData = result.data.filter((x) =>
              x.extraChargeCode.includes("DTransfer")
            );
  ...
  const oldEmpCode = "/tnsctpedomcdv";
  const oldTrstCode = "/tnsctrstdomcdv";
  ...
  const fnCheckOldUserAuth = () => {
    ...
    var result = arrRole.filter(
      (x) => x.RoleCode === oldEmpCode || x.RoleCode === oldTrstCode
    );
    if (!result.length) {
      return false;
    } else {
  ...
  const fnCheckUserAuth = () => {
    ...
    var arrRole = JSON.parse(strArr);
    var result = arrRole.filter(
      (x) => x.RoleCode === empCode || x.RoleCode === trstCode
    );
    if (!result.length) {
        ...
        <CCard className="mb-1" xs="12" sm="6" md="12">
          ...
          <CCollapse show={collsFormSearch === 1}>
            ...
            <CRow className="ml-2 mr-2 p-0">
              ...
              {/* <CCol xs="12" sm="6" md="3">
                                <CFormGroup>
                                    <CLabel htmlFor="name">{Constant.arrFieldTransCreditDebitMainSearch[4]}</CLabel>
                                    <Box className='border-set' component={Grid} item boxShadow={1} xs={{
                                        ...
                                        >
                                            ...
                                            {transporterTypeList.map((x) => <option value={x.valueMember} >{x.displayMember} </option>)}
                                        </CSelect>
                                    </Box>
              ...
              {/* <CCol xs="12" sm="6" md="3">
                                <CFormGroup>
                                    <CLabel htmlFor="name">{Constant.arrFieldTransCreditDebitMainSearch[6]}</CLabel>
                                    <Box className='border-set' component={Grid} item boxShadow={1} xs={{
                                        width: ' 100%'
                                    }}>
                                        <CSelect className="form-control"
                                        ...
                                        >
                                            <option selected hidden value="">{Constant.txtformPlaceholderSelected}</option>
                                            <option value="">{Constant.txtFormAllSelected}</option>
                                            {extraChargeGroupList.map((x) => <option value={x.valueMember} >{x.displayMember} </option>)}
                                        </CSelect>
                                    </Box>
                                    <CInvalidFeedback>{Constant.inValidNullSelected}</CInvalidFeedback>
                                </CFormGroup>
                    ...
                    <CRow>
                      <CCol xs="6" sm="8" md="10">
                        <h3 className="headtext">
                          {Constant.txtTransactionApproveList}
                        </h3>
                      </CCol>
                      <CCol xs="6" sm="4" md="2">
                        {/* {dialogs("show")} */}
...
export default ApproveCreditDebitView;
