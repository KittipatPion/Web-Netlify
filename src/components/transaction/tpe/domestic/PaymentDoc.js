...
const DeliveryList = () => {
  ...
  const fnGetDataList = (arrData = []) => {
    ...
    Repository.fetchGetDomDeliveryListForCreatePayment(arrData).then(
      (result) => {
            ...
            <CCollapse show={collsFormSearch}>
              <CCardBody>
                <CRow className="ml-2 mr-2 p-0">
                  ...
                  <CCol xs="12" sm="6" md="3" style={{ overflow: "auto" }}>
                    <CFormGroup>
                      <CFormGroup>
                        <CLabel htmlFor="name">
