...
const ApproveExportPayment = () => {
  ...
  const onClickSearchData = () => {
    ...
    deliveryMode = !isNaN(deliveryMode) ? deliveryMode : 0;
                ...
                <CRow className="ml-2 mr-2 p-0">
                  ...
                  <CCol xs="12" sm="6" md="3">
                    <CFormGroup>
                      ...
                      >
                        <CSelect id="search-deliveryMode" value={1} disabled>
                          <option selected hidden value="">
                            {Constant.txtformPlaceholderSelected}
                          </option>
                          <option value="0">{Constant.txtFormAllSelected}</option>
                ...
                <CCardHeader>
                  <CRow>
                    <CCol xs="6" sm="8" md="10">
                      ...
                      {/* Approve Payment List (งานขนลง) */}
                        {Constant.txtTransactionApprovePaymentList}y
                      </h3>
                    </CCol>
                    <CCol xs="6" sm="4" md="2">
                      {layoutDialogInvoice()}
...
export default ApproveExportPayment;
