...
const Tables = () => {
  ...
  const onClickSearchData = () => {
    ...
    // console.log(newArr);
    fnGetInterfaceErrorLog(newArr);
  };

  const onClickClearDataForSearch = () => {
  };

  const fnGetInterfaceErrorLog = (arrData = []) => {
    setIsPostingData(true);
    Repository.fetchGetInterfaceErrorLog(arrData).then(
      (result) => {
                  ...
                  <CCol xs="6" sm="6" md="12">
                    ...
                    <CRow>
                      <CCol xs="12" sm="4" md="3">
                        ...
                        >
                          <CInput type="text" id="search-deliveryNo" />
                        </Box>
                      </CCol>
                      <CCol xs="12" sm="4" md="3">
                        ...
                        >
                          <CInput type="text" id="search-shipmentNo" />
                        </Box>
                      </CCol>
                      <CCol xs="12" sm="4" md="3">
                        <CLabel>Sale Order No.</CLabel>
                        <Box
                          className="border-set"
                          component={Grid}
                          item
                        ...
                        >
                          <CInput type="text" id="search-saleOrderNo" />
                        </Box>
                      </CCol>
                    </CRow>
            ...
            <CCol>
              <CCard>
                <CCardHeader>
                  <CRow>
                    <CCol>
                      <div className="headertable">Interface Error Log</div>
                    </CCol>
                  </CRow>
                </CCardHeader>
                <CCardBody>
